...
var networksResource = schema.GroupVersionResource{Group: "samplecrd.k8s1.io", Version: "v1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "samplecrd.k8s1.io", Version: "v1", Kind: "Network"}
